...
export default function RootError({
  ...
  return (
    <div className="container mx-auto flex min-h-[70vh] flex-col items-center justify-center px-4 py-16 text-center max-w-lg">
      <div className="rounded-2xl border border-surface-border bg-surface/70 backdrop-blur-xl p-8 shadow-2xl w-full">
        ...
        <p className="text-xs sm:text-sm text-muted mb-6 leading-relaxed">
          An unexpected error occurred while processing this request. You can try refreshing the component or returning to the homepage.
        </p>
